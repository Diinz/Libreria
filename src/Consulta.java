...
public class Consulta extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		try {
			...
			if (pool == null) {
				throw new ServletException("ERROR AL ACCEDER AL POOL DE CONEXIONES(NULL)");
			}
	...
	protected void doGet(HttpServletRequest request,
		...
		// Preparamos la salida del servidor.
		...
		try {
			...
			try {
				...
				System.out
						.println("ERROR AL CERRAR LOS OBJETOS DE LA BASE DE DATOS");
